...
INSERT INTO TBL_USERS (`name`, `age`, `email`, `password`, `user_encoded_image`, `created_at`, `updated_at`)
VALUES
    ('John Doe', 28, 'jdoe@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_john', '2023-11-24', '2023-11-24'),
    ('Alice Johnson', 25, 'alicej@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_alicej', '2023-11-24', '2023-11-24'),
    ('Bob Brown', 30, 'bobb@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_bobb', '2023-11-24', '2023-11-24'),
    ('Charlie Green', 28, 'charlieg@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_charlieg', '2023-11-24', '2023-11-24'),
    ('David White', 35, 'davidw@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_davidw', '2023-11-24', '2023-11-24'),
    ('Eva Black', 32, 'evab@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_evab', '2023-11-24', '2023-11-24'),
    ('Frank Gray', 29, 'frankg@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_frankg', '2023-11-24', '2023-11-24'),
    ('Grace Red', 31, 'gracer@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_gracer', '2023-11-24', '2023-11-24'),
    ('Harry Yellow', 27, 'harryy@gmail.com', '$2a$10$fMiSJWHE0Oo/84OIzrb1xOnR1wBBmu4SvIzW3o3hYritUjExB87Oq', 'encoded_image_harryy', '2023-11-24', '2023-11-24');
...
values
    ...
    ('Haircut', 25.00, '2023-12-13', 'Regular haircut', 'Personal Care', '2023-12-13-Haircut', 'https://example.com/bill/haircut', '2023-12-13', '2023-12-13', 1),
    ('Toiletries', 20.00, '2023-12-14', 'Purchase of personal hygiene products', 'Personal Care', '2023-12-14-Toiletries', 'https://example.com/bill/toiletries', '2023-12-14', '2023-12-14', 9),
    ...
    ('Books and Supplies', 50.00, '2023-12-18', 'Purchase of books and school supplies', 'Education', '2023-12-18-Books-and-Supplies', 'https://example.com/bill/books-and-supplies', '2023-12-18', '2023-12-18', 9),
